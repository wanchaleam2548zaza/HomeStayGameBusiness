export const TITLES = {
    ...
    WORLD_MONOPOLY: {
        ...
        hypeBonus: 200,     // +200% Hype ทันที
        repBonus: 100,      // +100 Reputation ทันที
        incomeBonus: 0.5,   // +50% รายได้ต่อ tick
        loanBonus: 5000000, // วงเงินกู้เพิ่ม ฿5,000,000
        stockBonus: 2.0,    // ราคาหุ้นคูณ x2.0
    ...
    ILLUMINATI_CEO: {
        ...
        hypeBonus: 150,
        repBonus: 150,
        incomeBonus: 0.4,   // +40% รายได้ต่อ tick
        loanBonus: 3000000,
        stockBonus: 1.8,
    ...
    SMART_SAVER: {
        ...
        hypeBonus: 5,
        repBonus: 15,
        incomeBonus: 0.05,  // +5% รายได้ (เน้นออม)
        loanBonus: 80000,
        stockBonus: 1.03,
        color: '#1eff00', dropRate: 74.98, minBid: 100000
    },

    // ⚪ STARTER (ผู้เริ่มต้น - สำหรับมือใหม่)
    ROOKIE_CEO: {
